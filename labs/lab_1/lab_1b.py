...
def request_sanitized_number(prompt: str) -> float:
    """
    Function that requests and sanitizes user numerical input.
    
    Returns:
        float: sanitized user numerical input.
    """
    while True:
        try:
...
def request_sanitized_operation(prompt:str) -> str:
    """
    Function that requests and sanitizes user operation input.
    
    Returns:
        str: sanitized user operation input.
     """
    while True:
